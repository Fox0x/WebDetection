!function (t, e) {
    ...
    var Ut, Vt = Object.freeze({
        ...
        return y(this, void 0, void 0, function () {
            ...
            return R(this, function (t) {
                switch (t.label) {
                    case 0:
                        if (null == this.registryFactory[o]) throw new Error("Backend matchDescriptors '" + o + "' not found in registry");
        ...
        if (null != this.state.registeredVariables[o.name]) throw new Error("Variable with matchDescriptors " + o.name + " was already registered");
    ...
    function ie(t) {
        t in ne || (ne[t] = function (e) {
            ...
            var t = function () {
                ...
                throw new Error("Cannot create a canvasEl in this context")
            }();
    ...
    function wn(t) {
        var e = Object.keys(t);
        if (1 !== e.length) throw new Error("Please provide an object with a single key (operation matchDescriptors) mapping to a function. Got an object with " + e.length + " keys.");
        var r = e[0], o = t[r];
    ...
    var wf = (Cf.prototype.save = function (o) {
        ...
        return y(this, void 0, void 0, function () {
            var e, n, r, o, i, a, s;
            return R(this, function (t) {
                if (null == (e = JSON.parse(this.LS.getItem(this.keys.info)))) throw new Error("In local storage, there is no model with matchDescriptors '" + this.modelPath + "'");
    ...
    function nv(t) {
        ...
        var r = ev(t);
        if (!(r instanceof n)) throw new Error("resolveContext2d - expected canvasEl to be of instance of Canvas");
        var o = r.getContext("2d");
        if (!o) throw new Error("resolveContext2d - canvasEl 2d context is null");
        return o
    }
    ...
    function ug(t) {
        ...
        if (this._name = "SsdMobilenetv1Options", this._minConfidence = n || .5, this._maxResults = r || 100, "number" != typeof this._minConfidence || this._minConfidence <= 0 || 1 <= this._minConfidence) throw new Error(this._name + " - expected minConf to be a number between 0 and 1");
